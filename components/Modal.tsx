...
import { XIcon, PlusIcon, ThumbUpIcon, VolumeUpIcon, VolumeOffIcon } from '@heroicons/react/outline'
            ...
            <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 py-8">
                <div className="space-y-6 text-lg">
                    ...
                    <div className="flex flex-col gap-x-10 gap-y-4 font-light md:flex-row">
                        <p className="line-clamp-3 w-5/6">{movie?.overview}</p>
                        <div className="flex flex-col space-y-3 text-sm">
                            ...
                            <div>
                                <span className="text-[gray]">Langue Originale : </span>
                                {movie?.original_language}
                            </div>
                            <div>
                                <span className="text-[gray]">Nombre de Vote : </span>
                                {movie?.vote_count}
                            </div>
                        </div>
                    </div>
